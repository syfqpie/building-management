...
class Billing(models.Model):
    ...
    unit = models.ForeignKey(
        Unit, on_delete=models.CASCADE, null=True, related_name="unit_billings"
    )

    is_paid = models.BooleanField(default=False)
    paid_at = models.DateTimeField(null=True)
    bill_attachment = models.ForeignKey(Media, on_delete=models.CASCADE, null=True)
...
class MaintenanceBaseFee(models.Model):
